...
namespace RIAPP.DataService.EFCore
{
       ...
       where TDB : DbContext
    {
        ...
        private void UpdateNestedFieldInfo(Field fieldInfo, PropertyInfo propInfo)
        {
            ...
            fieldInfo.isNullable = ServiceContainer.ValueConverter.IsNullableType(propInfo.PropertyType) || (propInfo.PropertyType == typeof(string) && !propInfo.GetCustomAttributes<RequiredAttribute>().Any());
