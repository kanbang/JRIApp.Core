...
<br/>
<br/>
Also, the longevity of project develped with this framework is very good, because the framework (the core) is stable and there's no need to change anything. Typescript makes it even more stable,
